...
from monan_jedi_workflow import scheduler
...
def make_config(tmp_path: Path) -> ExperimentConfig:
    return ExperimentConfig(
        ...
        pbs={"pbs": {"log": {"directory": "logs", "filename": "run.${PBS_JOBID}.log"}}}, validation={},
    )
